...
/*
    Copyright (C) 2007-2013 Ben Kibbey <bjk@luxsci.net>
...
static struct menu_item_s **get_file_items(WIN *win)
{
...
static void file_browser_finalize(WIN *win)
{
...
static void file_browser_home(struct menu_input_s *m)
{
    struct input_s *in = m->data;
    char *path = in->arg;
    struct passwd *pw;
...
static void file_browser_expression(struct menu_input_s *m)
{
...
static void file_browser_print(WIN *win)
{
    int i, len = 0;
    struct menu_input_s *m = win->data;

...
/*
    Copyright (C) 2007-2019 Ben Kibbey <bjk@luxsci.net>
...
int
perl_init_file (const char *filename, perl_error_func * efunc)
{
  const char *args[] = { "", "-e", "0" };
  char *buf;
  int argc;
...
int
perl_call_sub (const char *str, const char *arg, char **result)
{
  int flags = G_EVAL;
  int ret = 0;

...
#ifndef HAVE_PUTWC_UNLOCKED
#ifdef HAVE_PUTW_UNLOCKED
#define putwc_unlocked putw_unlocked
#else
#define putwc_unlocked putc_unlocked
#define putw_unlocked putc_unlocked
#endif
#endif
